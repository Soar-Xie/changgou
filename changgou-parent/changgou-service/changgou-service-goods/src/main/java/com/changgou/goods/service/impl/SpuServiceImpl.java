...
public class SpuServiceImpl implements SpuService {
    ...
    public Goods findGoodsByiD(Long id) {
        ...
        //查询List<sku>-》spuI select * from tb_sku from where spu_id=?
        Sku sku = new Sku();
        sku.setSpuId(id);
    ...
    public void saveGoods(Goods goods) {
        //修改spu,删除之前的List<Sku>,新增组合的List<Sku>
        ...
        for (Sku sku : skuList) {
            ...
            sku.setCategoryName(category.getName());  //分类名字 3级名字
            sku.setBrandName(brand.getName());     //品牌名牌
